...
const PrivacyPolicyManager: React.FC<PrivacyPolicyManagerProps> = ({ onBack }) => {
  ...
  const fetchPrivacyPolicy = async () => {
    try {
      ...
      setStatus('error');
      setStatusMessage('Failed to load privacy policy data');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-3">
            ...
            <h1 className="text-2xl font-bold text-gray-900">Privacy Policy Manager</h1>
          </div>
        </div>
      ...
      <div className="bg-white rounded-2xl p-6 border border-gray-200">
        ...
        <div className="mt-6">
          ...
          <textarea
            ...
            placeholder="Enter the introduction text for your privacy policy..."
          />
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl p-6 border border-gray-200">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl font-semibold text-gray-900">Policy Sections</h2>
          <motion.button
            onClick={addSection}
